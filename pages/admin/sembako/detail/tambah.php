        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="harga_pedagang_1" id="harga_pedagang_1">
            </div>
            <div class="form-group">
              <label for="">Harga Pedagang 2</label>
              <input type="number" class="form-control" name="harga_pedagang_2" id="harga_pedagang_2">
            </div>
            <div class="form-group">
              <label for="">Harga Pedagang 3</label>
              <input type="number" class="form-control" name="harga_pedagang_3" id="harga_pedagang_3">
            </div>
            <div class="form-group">
...
<script>
  const saveData = async (data) => {
    return await axios.post(`<?= $base_url ?>api/add-detail-sembako.api.php`, {
