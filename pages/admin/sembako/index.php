...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Pasar yang sudah dimonitoring</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if($role_id == 2): ?>
                        ...
                        <a href="?page=sembako&action=edit&id=<?= $datum['id'] ?>" class="btn btn-primary float-right mx-2" role="button">
...
<script>
  ...
  const doDelete = async (data) => {
    return await axios.post(`<?= $base_url ?>api/delete-sembako.api.php`, data, {
      headers: {
