<?php
  ...
  include "controller/admin-harga-produsen.controller.php";
  include "controller/get-produsen.controller.php";
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($role_id != 1): ?>
                        ...
                        <a href="?page=produsen&action=edit&id=<?= $dt[id] ?>" class="btn btn-primary float-right mx-2" role="button">
