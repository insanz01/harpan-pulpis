<?php
  ...
  include "controller/satuan.controller.php";
                  ...
                  <?php while($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="index.php?page=satuan&action=edit&id=<?= $row['id'] ?>" class="btn btn-primary float-right mx-2" role="button">
      ...
      if(role_id == 1) {
        ...
        temp += `
                <td>
                  ...
                  <a href="index.php?page=satuan&action=edit&id=${res.id}" class="btn btn-primary float-right mx-2" role="button">
                    <i class="fas fa-fw fa-edit"></i>
                    Ubah
                  </a>
                </td>
